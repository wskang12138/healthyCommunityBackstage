...
export default {
  ...
  actions: {
    async findDiease({ commit }, payload) {
      const res = await request.get('/familyDiease/findDiease', {
        params: {
          ...payload
        }
      })
    ...
    async deleteDiease({ commit }, payload) {
      const res = await request.get('/familyDiease/deleteDiease', {
        params: {
          ...payload
        }
      })
    ...
    async saveOrUpdateDiease({ commit }, payload) {
      const res = await request.post('/familyDiease/saveOrUpdateDiease', {
        ...payload
      })
      return res
    }
