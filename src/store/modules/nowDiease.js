...
export default {
  ...
  actions: {
    async findDiease({ commit }, payload) {
      const res = await request.get('/nowDiease/findDiease', {
        params: {
          ...payload
        }
      })
    ...
    async deleteDiease({ commit }, payload) {
      const res = await request.get('/nowDiease/deleteDiease', {
        params: {
          ...payload
        }
      })
    ...
    async saveOrUpdateDiease({ commit }, payload) {
      const res = await request.post('/nowDiease/saveOrUpdateDiease', {
        ...payload
      })
      return res
    }
